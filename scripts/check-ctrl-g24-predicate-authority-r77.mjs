...
check('canonical next action remains inside approved local contract gate', state.includes('**CURRENT_NEXT_ACTION:** Freeze the exact [R81 end-to-end bound predicate-authority contract]') && state.includes('No semantic evaluator implementation'))
check('design route agrees', design.includes('freeze the exact R81 end-to-end bound predicate-authority contract') && design.includes('No semantic evaluator implementation'))
