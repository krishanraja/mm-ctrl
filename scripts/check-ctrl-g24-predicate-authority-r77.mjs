...
check('canonical next action remains inside approved local contract gate', state.includes('**CURRENT_NEXT_ACTION:** Freeze the exact [R79 executable predicate-authority repair]') && state.includes('No semantic evaluator implementation'))
check('design route agrees', design.includes('freeze the exact R79 executable predicate-authority repair') && design.includes('No semantic evaluator implementation'))
