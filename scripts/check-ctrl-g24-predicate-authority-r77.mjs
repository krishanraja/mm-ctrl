...
check('canonical next action remains inside approved local contract gate', state.includes('**CURRENT_NEXT_ACTION:** Freeze the exact [R85 resolved human authority contract]') && state.includes('No semantic evaluator implementation'))
check('design route agrees', design.includes('freeze the exact R85 resolved human authority contract') && design.includes('No semantic evaluator implementation'))
