...
check('canonical next action remains inside approved local contract gate', state.includes('**CURRENT_NEXT_ACTION:** Freeze the exact [R88 human-owned answer history and self-healing finality contract]') && state.includes('No semantic evaluator implementation'))
check('design route agrees', design.includes('freeze the exact R88 human-owned answer history and self-healing finality contract') && design.includes('No semantic evaluator implementation'))
