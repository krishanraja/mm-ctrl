...
await expect('route is explicitly development-only', routerText.includes('import.meta.env.DEV && isLockedFixture'))
...
try {
  ...
  await page.getByTestId('decision-bench').waitFor()
  ...
  await mobilePage.getByTestId('decision-bench').waitFor()
