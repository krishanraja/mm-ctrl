...
check(
  ...
  state.includes('**CURRENT_NEXT_ACTION:** Materialize, freeze and independently attack the G24 trusted canonical ingress R20 repair'),
)
check(
  'design state remains inside the trusted-ingress gate',
  designState.includes('materialize, freeze and independently attack the trusted canonical ingress R20 repair'),
)
