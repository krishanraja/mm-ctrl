...
import { PeerComparisonMobile } from './PeerComparisonMobile';
...
export const PeerBubbleChart: React.FC<PeerBubbleChartProps> = ({ 
  ...
  // Mobile: Render stacked comparison view instead of bubble chart
  if (isMobile && chartData.stats) {
    return (
      <PeerComparisonMobile
        userDimensions={userDimensions}
        totalPeers={chartData.stats.totalPeers}
        overallPercentile={chartData.stats.percentileRank}
      />
    );
  }
