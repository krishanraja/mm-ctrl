...
export function SampleResultsDialog({ onStartQuiz, onStartVoice }: SampleResultsDialogProps) {
  ...
  return (
    <>
      {/* Trigger Button - Clear mobile label */}
      <Button
        variant="ghost"
        size="sm"
      ...
      >
        ...
        <span className="whitespace-nowrap">View Examples</span>
      </Button>
        ...
        <DialogContent className="max-w-2xl p-0 gap-0">
          ...
          <div className="px-4 pt-4 pb-3 border-b">
            ...
            <DialogDescription className="text-sm text-muted-foreground mt-0.5">
              Preview the personalized insights and peer comparison you'll receive
            </DialogDescription>
          </div>
