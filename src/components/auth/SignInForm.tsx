  ...
  return (
    <Card className="w-full max-w-lg">
      <CardHeader className="pb-8">
        <CardTitle className="text-3xl sm:text-4xl font-bold">Sign In</CardTitle>
        <CardDescription className="text-base sm:text-lg mt-3">Enter your credentials to continue</CardDescription>
      </CardHeader>
      <CardContent>
