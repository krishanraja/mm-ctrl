...
The repository contains 125 Edge Function directories excluding `_shared`, 51 hook files, and 200 SQL migrations. These are measured source-tree inventory counts, not design targets.
