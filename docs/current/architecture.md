...
The repository contains 115 Edge Function directories excluding `_shared`, 51 hook files, and 171 SQL migrations. These are measured source-tree inventory counts, not design targets.
