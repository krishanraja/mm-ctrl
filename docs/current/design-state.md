...
**The one current evolution action:** specify and independently attack trusted canonical ingress, then continue the remaining G24.C semantic attacks. Customer-facing UI and every external action remain closed.
