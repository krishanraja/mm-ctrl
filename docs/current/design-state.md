...
**The one current evolution action:** repair the exact trusted canonical ingress R10 derivation defects as R11, then independently attack the frozen R11 bytes. Customer-facing UI and every external action remain closed.
