...
**The one current evolution action:** independently attack the exact trusted canonical ingress R7 repair, then, only if it clears, open its bounded local adapter and adversarial fixtures. Customer-facing UI and every external action remain closed.
