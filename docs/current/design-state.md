...
**The one current evolution action:** materialize, freeze and independently attack the trusted canonical ingress R18 repair. Customer-facing UI and every external action remain closed.
