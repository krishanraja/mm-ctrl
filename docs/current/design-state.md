...
**The one current evolution action:** materialize, freeze and independently attack the trusted canonical ingress R20 repair. Customer-facing UI and every external action remain closed.
