...
**The one current evolution action:** repair the exact trusted canonical ingress R11 issuance, identity, question, outbox and versioning defects as R12, then independently attack the frozen R12 bytes. Customer-facing UI and every external action remain closed.
