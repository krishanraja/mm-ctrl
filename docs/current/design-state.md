...
**The one current evolution action:** freeze and independently attack the fully materialized trusted canonical ingress R28 repair. Customer-facing UI and every external action remain closed.
