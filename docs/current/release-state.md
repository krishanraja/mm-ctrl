...
| Edge Function source inventory | 122 directories excluding `_shared` |
| Shared-project Edge Functions | 183 live |
| Hook files | 51 |
| SQL migration files | 196 in the source tree |

Current source inventory is 122 Edge Function directories excluding `_shared`, 51 hook files, and 196 SQL migration files. The 183-function shared-project total is deployment inventory, not repository ownership.
