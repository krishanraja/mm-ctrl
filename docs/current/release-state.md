...
| Edge Function source inventory | 123 directories excluding `_shared` |
| Shared-project Edge Functions | 183 live |
| Hook files | 51 |
| SQL migration files | 197 in the source tree |

Current source inventory is 125 Edge Function directories excluding `_shared`, 51 hook files, and 200 SQL migration files. The 183-function shared-project total is deployment inventory, not repository ownership.
