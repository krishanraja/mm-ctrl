...
Measured in the current source tree on 2026-09-08: 115 Edge Function directories excluding `_shared`, 51 hook files, and 171 SQL migrations. `npm run docs:check` prevents these quoted counts from drifting silently.
