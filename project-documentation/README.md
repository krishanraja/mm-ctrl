...
Measured in the current source tree on 2026-09-18: 118 Edge Function directories excluding `_shared`, 51 hook files, and 182 SQL migrations. `npm run docs:check` prevents these quoted counts from drifting silently.
