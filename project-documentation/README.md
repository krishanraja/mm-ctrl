...
Measured in the current source tree on 2026-09-19: 122 Edge Function directories excluding `_shared`, 51 hook files, and 196 SQL migrations. `npm run docs:check` prevents these quoted counts from drifting silently.
