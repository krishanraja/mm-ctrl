...
Measured in the current source tree on 2026-09-20: 125 Edge Function directories excluding `_shared`, 51 hook files, and 199 SQL migrations. `npm run docs:check` prevents these quoted counts from drifting silently.
