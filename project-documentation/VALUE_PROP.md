...
|-----|-------|-----------------|----------|
| **Free / Core** | $0 | Memory Web, Context Export (all 6 tools), Onboarding, basic Daily Briefing, Decision Advisor, Meeting Prep, Prompt Coach, Edge profile (preview) | Every new leader. The "land" in land-and-expand. |
