...
3. `corrected`: an authorised correction supersedes the exact mistaken claim and repairs its downstream uses without erasing still-valid claims from the same source.
