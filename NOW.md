...
- **Live** at `makeyourmindup.ai`. Frontend baseline `860dea0`, Vercel `dpl_2JFRfmZRzUvxbdwXqLunG3eubTgc`, READY and PROMOTED from that exact `main` SHA (`docs/current/release-state.md`). Vercel builds every push to `main`.
