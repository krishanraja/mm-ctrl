const INPUT_SCHEMA_VERSION = 'ctrl.g24.executable-input.evaluate-lifecycle-preconditions.r70.v1'
...
const isIdentifier = value => {
  if (typeof value !== 'string' || value !== value.trim() || value.normalize('NFC') !== value) return false
...
export function dispatchEvaluateLifecyclePreconditionsStructuralR70(input) {
  try {
