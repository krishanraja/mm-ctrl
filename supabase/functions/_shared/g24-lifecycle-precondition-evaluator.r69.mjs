const INPUT_SCHEMA_VERSION = 'ctrl.g24.executable-input.evaluate-lifecycle-preconditions.r69.v1'
const OUTPUT_SCHEMA_VERSION = 'ctrl.g24.executable-output.evaluate-lifecycle-preconditions.r69.v1'
...
export function dispatchEvaluateLifecyclePreconditionsStructuralR69(input) {
  try {
